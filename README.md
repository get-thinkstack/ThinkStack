...
tests/             <!-- autodoc:tests -->319 tests across 23 modules<!-- /autodoc -->
```
...
|---|---|---|
| `preflight.sh` | your machine, every push | lint, <!-- autodoc:test_count -->319<!-- /autodoc --> tests, shellcheck, actionlint, cargo |
